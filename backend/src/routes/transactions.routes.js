...
// Borrow a book copy
router.post('/borrow', authenticate, requireRole('librarian', 'master'), async (req, res) => {
  try {
...
// Return a book copy
router.post('/return', authenticate, requireRole('librarian', 'master'), async (req, res) => {
  try {
    ...
    if (!activeTransaction) {
      return res.status(400).json({ error: 'No active loan for this book copy' });
    }
